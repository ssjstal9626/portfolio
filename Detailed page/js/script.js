jQuery('<div class="quantity-nav"><div class="quantity-button quantity-up"><img src="./images/up.png"></div><div class="quantity-button quantity-down"><img src="./images/down.png"></div></div>').insertAfter('.quantity input');
...
$(function () {
  ...
  $(".quantity-button").click(function () {
    ...
    $(".total").text(totalNumb);//콤마 붙여서 총가격에 입력
  });
